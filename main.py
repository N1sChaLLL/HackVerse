        ...
        dummy_levels_data = [
            {
                ...
                "video_url": "YOUR_BRUTE_FORCE_VIDEO_URL", 
            ...
            },
            {
                ...
                "video_url": "YOUR_STEGANOGRAPHY_VIDEO_URL", 
                "video_description": "Introduction to steganography techniques.",
                "image_url": "steganography_challenge_image.jpg", 
                "instructions": "The flag is in the format FLAG{...}. Use Stegonline and keep R G B as 0 0 0. ",
                "flag": "FLAG{S3CR3T_IN_IMG}",
                "hint": "Common steganography involves hiding data in the least significant bits of image pixels, or sometimes in metadata."
            },
            {
                ...
                "answer": {"username": "SMAGMSHOKM", "password": "KDNVOXAXBSV"}, 
